...
import {
  ...
  Circle, Clock, FileText, AlertTriangle, Ban, Users, Building2, Layers,
} from 'lucide-react'
    ...
    <div className="p-4 sm:p-6 max-w-3xl mx-auto">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
        ...
        <div className="p-5 sm:p-6">
          ...
          {(request.issue || request.issueTitleSnapshot) && (
            <div className="mt-5 bg-slate-50 rounded-xl border border-slate-200 p-4">
              ...
              <IssueBadge
                ...
                title={request.issueTitleSnapshot ?? request.issue?.title}
          ...
          {request.domain && (
            <div className="mt-5 bg-slate-50 rounded-xl border border-slate-200 p-3 flex items-center gap-2 text-xs text-slate-600">
              <Layers className="w-3.5 h-3.5 text-slate-400" /> Domain / Nature: {request.domain.name}
            </div>
          )}
          ...
          {request.workOrder && (
            <div className="mt-5 bg-blue-50/60 border border-blue-100 rounded-xl p-4">
              ...
              {!request.issue && (request.workOrder.issueTitleSnapshot || request.workOrder.issue || request.workOrder.customIssue) && (
                <p className="mt-2 flex items-center gap-1.5 flex-wrap">
                  ...
                  <IssueBadge
                    ...
                    title={request.workOrder.issueTitleSnapshot ?? request.workOrder.issue?.title}
