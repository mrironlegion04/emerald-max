 ...
 * and the category may be switched between categories but never cleared.
 */
export function canChangePMGeneratedWOFields(
  wo: { maintenanceScheduleId: string | null },
  ...
  if (changes.woCategoryId !== undefined && !changes.woCategoryId) {
