...
export default async function WorkOrderDetailPage({
  ...
  const wo = await prisma.workOrder.findUnique({
    ...
    include: {
      ...
      subtasks:     { include: { assignedTo: { select: { id: true, name: true, email: true } }, assignedTeam: { select: { id: true, name: true } }, completedBy: { select: { id: true, name: true, email: true } }, createdBy: { select: { id: true, name: true } } }, orderBy: { createdAt: 'desc' } },
